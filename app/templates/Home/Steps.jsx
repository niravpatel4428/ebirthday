...
const Steps = () => {
  return (
    <div className="relative pt-20 md:pt-16 pb-[110px] md:pb-[150px]">
      <div className="container">
                  ...
                  <div className="flex flex-row justify-between mb-6">
                    <div className="w-[80%]">
                      ...
                      <p className="font-onest text-blue/60 text-sm lg:text-base font-normal tracking-[-0.16px] leading-[141%]">
                        Log in, add the birthday name, message, photo, and
                        choose a design.
                      </p>
                    </div>
        ...
        <Image
          src={step1}
          alt="icon"
          className="object-contain w-[55px] md:w-[76px] xl:w-[114px] absolute top-[160px] md:top-[88px] left-[4%] md:left-[18%] animate-rotate"
        />
        <Image
          src={step2}
          alt="icon"
          className="object-contain w-[55px] md:w-[76px] xl:w-[114px] absolute top-[52px] md:top-[88px] right-[4%] md:right-[18%] animate-rotate"
        />
      </div>
    </div>
  );
