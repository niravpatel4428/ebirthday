      ...
      <div className="container h-[100%]">
        <div className="grid lg:grid-cols-2 h-[100%] gap-10 py-5">
          <div className="w-full lg:max-w-[370px] h-full flex flex-col justify-center pb-5">
            ...
            <form className="flex flex-col gap-[19px] mb-5">
              {/* inputs */}
              <div className="relative">
                <label
                  htmlFor="name"
                  className="text-black font-onest text-xs font-bold block mb-2 capitalize"
                >
                  Name
                </label>
                <div className="relative ">
              ...
              <div className="w-full">
                <button className="rounded-xl text-white font-onest text-sm !leading-normal font-bold bg-orange hover:bg-orange/80 transition-all p-[15px] w-full capitalize">
                  Sign Up
                </button>
              </div>
              <div className="relative">
            ...
            <div className="text-[#18181B] text-xs text-center font-onest font-normal">
